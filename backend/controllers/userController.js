...
exports.resetPassword = async(req, res ) =>{
    ...
    const new_secret = user.password + process.env.JWT_SECRET
    try {
       ...
       if(!verify){
        ...
        return res.status(500).json({message: "An error occur while resetting your password", error: error.message})
    }
}