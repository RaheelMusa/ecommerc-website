  ...
  return (
    <div>
       <div className="flex flex-col gap-3 items-center justify-center my-3">
            ...
            />
            <button onClick={handleFilterApply} className='w-full bg-blue-400 p-2 rounded-md hover:bg-blue-600 text-white hover:duration-300 hover:ease-in-out delay-100'>Apply Rating Filter</button>
          </div>
    </div>
  )
}
